...
<section class="">
	...
	<section  class="wrapper-lg scrollable">
		<div class="text-center m-t-xl ">
			...
			<div class="test ">	
				<p class="h4 md m-t-xl text-center font-400" ><a href="javascript:;" class="audition-btn"><i class="fa fa-volume-down fa-lg m-r"></i></a>请点击左侧喇叭进行听力测试</p>
				<p class="h4 md m-t-sm text-center ready-info font-400" >请在考试前调整好听力音量, 以免影响考试</p>
			</div>
		</div>
	</section>
	<div class="d-n">
		<audio id="audition">
			<source src="/res/audio/static/TFMK-LISTENING-PRE.mp3" type="audio/mpeg">
		</audio>
	</div>
	
	<section class="d-n">
		<form action="/mock/listensection" method="post">
